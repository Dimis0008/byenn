...
def passwrd():
	...
	print('')
	urut = []
	urut.append(panel(f' [bold white]Hasil Crack [bold green]Ok[bold white] Tersimpan Ke[bold green]%s [bold white]'%(okc),width=43,title=f"[bold green]OK SAVE IN",style=f"bold white"))
